...
let logoutA=navUl.querySelectorAll('a')[2];
...
function renderNav(){
    ...
    if(getUserData()){
        ...
        navUl.querySelectorAll('a')[0].style.display='';
        navUl.querySelectorAll('a')[1].style.display='';
        ...
        guest.style.display=''*/
        navUl.querySelectorAll('a')[0].style.display='none';
        navUl.querySelectorAll('a')[1].style.display='none';
